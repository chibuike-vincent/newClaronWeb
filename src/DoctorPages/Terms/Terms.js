    ...
    return (
        ...
        <p class="first-text">
            ...
            <ul className='terms-list'>
                ...
                <li>Deliver targeted advertising, coupons, newsletters, and other information regarding promotions and the Site and our mobile applicationto you.</li>
        ...
        <p class="first-text">
            ...
            [We may use cookies, web beacons, tracking pixels, and other tracking technologies on the Site and our mobile application to help customize the Site and our mobile application and improve your experience. For more information on how we use cookies, please refer to our Cookie Policy posted on the Site, which is incorporated into this Privacy Policy. By using the Site, you agree to be bound by our Cookie Policy.]</p>
        </p>

        <p class="first-text">
            <h4>Internet-Based Advertising</h4>
            <p>Additionally, we may use third-party software to serve ads on the Site [and our mobile application], implement email marketing campaigns, and manage other interactive marketing initiatives. This third-party software may use cookies or similar tracking technology to help manage and optimize your online experience with us. For more information about opting-out of interest-based ads, visit the <a href="">Network Advertising Initiative Opt-Out Tool</a>  or <a href=""> Digital Advertising Alliance Opt-Out Tool.</a></p>
        </p>
        ...
        <p class="first-text">
          ...
          <p>Company Name: Claron Health International</p>

          <p>Address: No 2, Dodi Link, (Between Volta Street and Akosombo Road) Airport Residential, Accra, Ghana.</p>

          <p>Phone Number: +233 (0) 30 2771017</p>

          <p>Email: wellness@claronhealth.com</p>
        </p>
